...
This Chapter consist of Four parts. The first section gives a brief introduction to deep learning neural networks, including its history, its development and current application. The second section mainly talks about Convolutional Neural Networks, including different types of layers applied in this article. 
